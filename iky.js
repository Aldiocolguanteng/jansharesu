...
case 'sendbug':
        ...
        case 'creator':
               ...
               buttons = [{buttonId: '!sourcecode',buttonText:{displayText: 'SC'},type:1},{buttonId:'!infoig',buttonText:{displayText:'IG'},type:1},{buttonId:'!sewabot',buttonText:{displayText:'SEWA'},type:1}]
...
`
 ...
 ᗩᴋɪʀᴀᗷoтz々`, imageMessage: imageMsg,
   ...
   case 'command':
               list = []
               listmenu = [`groupmenu`,`photoxy`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`akiragroup`,`sewabot`]
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://telegra.ph/file/166271e47317ecbe47b28.jpg'
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
       ...
       case 'sc': 
       case 'src':
              textImg(`Bot ini menggunakan sc : https://github.com/RunDiHeroku/`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
